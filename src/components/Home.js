...
export default function Home({ movies, addFavorite, searchQuery }) {
  ...
  const { name, year, genre } = searchQuery;

  const filteredMovies = movies.filter(movie => {
    return (
      (name ? movie.Title.toLowerCase().includes(name.toLowerCase()) : true) &&
